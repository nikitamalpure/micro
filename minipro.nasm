...
;OUTPUT:
;gescoe@slave8:~$ cd Desktop
;gescoe@slave8:~/Desktop$ nasm -f elf64 calci.nasm
;gescoe@slave8:~/Desktop$ ld -o calci calci.o
;gescoe@slave8:~/Desktop$ ./calci
