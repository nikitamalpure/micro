...
;	commands TYPE, COPY and DELETE using file operations. 	User is supposed to provide  command line arguments in 	all cases. 
;Name:-Nikita Malpure 
;Roll No:- 27
;Class: SE-A 
...
;Output:
;gescoe@gescoe-OptiPlex-3020:~/Desktop$ nasm -f elf64 type.asm 
;gescoe@gescoe-OptiPlex-3020:~/Desktop$ ld type.o -o type 
;gescoe@gescoe-OptiPlex-3020:~/Desktop$ ./type 
;MENU : 
;1. TYPE 
;2. COPY 
;3. DELETE 
